 ...
 * @author PauloPC
 */
public class LoginEventos extends javax.swing.JFrame {

    /**
     * Creates new form LoginEventos
     */
    public LoginEventos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginEventos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new LoginEventos().setVisible(true);
        });
    }
